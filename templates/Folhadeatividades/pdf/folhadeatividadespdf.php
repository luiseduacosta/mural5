...
<h2 style="text-align:center; line-height: 80%; margin: 0">
    ...
    <br />
    <span style="font-size: 100%">Folha de ativiades do(a) estagiário(a) <?= $estagiario->estudante->nome ?></span>
</h2>

<p style="font-size: 90%">DRE: <?= $estagiario->estudante->registro ?>
    Telefone: <?= $estagiario->estudante->celular ?>
    E-mail: <?= $estagiario->estudante->email ?>
</p>
...
<div class="container">
    ...
    <table class='table table-bordered' style="border: 1px; width: 90%; background-color: white;">
        ...
        <tbody>
            ...
            <?php foreach ($atividades as $c_atividade): ?>
                ...
                <?php
                list($hour, $minute, $second) = array_pad(explode(':', $estagiario->horario), 3, null);
    ...
    <table class="table" style="width: 100%; background-color: white;">
        <tr>
            ...
            <td style="width: 33%"><span style="font-size: 100%; text-decoration: overline"><?= $estagiario->estudante->nome ?></span></td>
            <td style="width: 33%"><span style="font-size: 100%; text-decoration: overline"><?= $supervisora ?></span></td>
        </tr>

        <tr>
            <td style="width: 33%"></td>
            <td style="width: 33%"><span style="font-size: 100%">DRE: <?= $estagiario->estudante->registro ?></span></td>
