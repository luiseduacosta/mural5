...
<table class="auxiliar">
    <tr class="auxiliar">
        ...
        <td class="auxiliar"><span style="font-size: 100%; text-decoration: overline"><?= $supervisora; ?></span></td>
    </tr>

    <tr class="auxiliar">
        <td class="auxiliar"><span style="font-size: 100%">DRE: <?= $estagiario->estudante->registro; ?></span></td>
        <td class="auxiliar"><span style="font-size: 100%">Supervisor(a) de campo</span><br><span>CRESS: <?= $cress; ?></span></td>
    </tr>
</table>
