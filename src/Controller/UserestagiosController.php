...
class UserestagiosController extends AppController {
    ...
    public function index() {
        $query = $this->Userestagios->find('all')->contain(['Estudantes', 'Supervisores', 'Professores']);
        $userestagios = $this->paginate($query);
    ...
    public function add() {
        ...
        $professores = $this->Userestagios->Professores->find('list');
