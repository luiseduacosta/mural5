...
<div class="ui-area-page">
    ...
    <div class="ui-pagehead">
        <div>
            <h1 class="mb-2">Editar área</h1>
            <p class="ui-pagehead-sub mb-0">Corrija o nome pelo qual as instituições desta área aparecem no mural.</p>
        </div>
    </div>
            ...
            <div class="ui-panel ui-panel--form">
                ...
                <div class="ui-field">
                    ...
                    <input type="text" id="areaName" name="area" class="form-control<?= $hasErrors ? ' is-invalid' : '' ?>"
                           value="<?= h($area->area) ?>" maxlength="90" required autocomplete="off">
                ...
                <div class="ui-form-actions">
                    <a class="btn btn-outline-secondary"
                       href="<?= h($this->Url->build(['action' => 'view', $area->id])) ?>">Cancelar</a>
                    <button type="submit" class="btn btn-primary" id="areaSubmit">Salvar alterações</button>
                </div>
                <?= $this->Form->end() ?>
            </div>
        </div>
