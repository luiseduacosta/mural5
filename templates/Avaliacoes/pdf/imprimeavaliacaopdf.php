...
<p><span style="font-size: 100%; text-align: justify; font-weight: normal">Campo de estágio
        <?= $avaliacao->estagiario->instituicao->instituicao ?>. Supervisor(a)
        <?= $avaliacao->estagiario->supervisor->nome ?>, Cress <?= $avaliacao->estagiario->supervisor->cress ?>. Período
        de estágio <?= $avaliacao->estagiario->periodo ?>. Nível: <?= $avaliacao->estagiario->nivel ?>. Supervisão
        acadêmica: <?= $professora ?></span></p>
...
<table class="table" style="width: 100%; background-color: white;">
    <tr>
        ...
        <td style="width: 33%"><span
                style="font-size: 100%; text-decoration: overline"><?= $avaliacao->estagiario->aluno->nome ?></span>
        </td>
    ...
    <tr>
        ...
        <td style="width: 33%"><span style="font-size: 100%">DRE:
                <?= $avaliacao->estagiario->aluno->registro ?></span></td>
