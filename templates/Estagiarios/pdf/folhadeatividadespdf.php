...
<div style="text-align:justify; font-size: 70%;">
    <p style="line-height:100%">
        ...
        Supervisor(a) de campo: <?= $supervisora; ?> CRESS: <?= $cress; ?> Celular:
        <?= '(' . $codigo_celular . ') ' . $celular; ?><br />
...
<table class="auxiliar">
    <tr class="auxiliar">
        ...
        <td class="auxiliar"><span
                style="font-size: 100%; text-decoration: overline"><?= $estagiario->aluno->nome; ?></span></td>
        <td class="auxiliar"><span
                style="font-size: 100%; text-decoration: overline"><?= $estagiario->supervisor->nome; ?></span></td>
    </tr>

    <tr class="auxiliar">
        <td class="auxiliar"></td>
        <td class="auxiliar"><span style="font-size: 100%">DRE: <?= $estagiario->aluno->registro; ?></span></td>
        <td class="auxiliar"><span style="font-size: 100%">CRESS 7ª Região:
                <?= $estagiario->supervisor->cress; ?></span></td>
    </tr>
</table>
