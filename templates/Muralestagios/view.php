                            ...
                            <tr>
                                ...
                                <?php if($user->isAdmin()): ?>
                                    <td>
                                        ...
                                        <?= $this->Form->postLink(__('Excluir'), ['controller' => 'Inscricoes', 'action' => 'delete', $inscricoes->id], ['confirm' => __('Tem certeza que quer excluir o registro # {0}?', $inscricoes->id), 'class' => 'link-danger']) ?>
                                    </td>
                                <?php endif; ?>
                            </tr>
                        <?php endforeach; ?>
