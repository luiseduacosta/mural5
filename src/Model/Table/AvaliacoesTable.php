...
class AvaliacoesTable extends Table
{
        ...
        public function validationDefault(Validator $validator): Validator
        {
                ...
                $validator
                        ->scalar('avaliacao15')
                        ->maxLength('avaliacao15', 1)
                        ->requirePresence('avaliacao15', 'create')
                        ->notEmptyString('avaliacao15');

                $validator
                        ->scalar('avaliacao16')
                        ->maxLength('avaliacao16', 256)
                        ->requirePresence('avaliacao16', 'create')
                        ->allowEmptyString('avaliacao16');

                $validator
                        ->scalar('avaliacao17')
                        ->maxLength('avaliacao17', 1)
                        ->requirePresence('avaliacao17', 'create')
                        ->notEmptyString('avaliacao17');

                $validator
                        ->scalar('avaliacao18')
                        ->maxLength('avaliacao18', 256)
                        ->requirePresence('avaliacao18', 'create')
                        ->allowEmptyString('avaliacao18');

                $validator
                        ->scalar('avaliacao19')
                        ->maxLength('avaliacao19', 256)
                        ->requirePresence('avaliacao19', 'create')
                        ->allowEmptyString('avaliacao19');
