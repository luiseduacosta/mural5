        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerVisita">
                <ul class="navbar-nav ms-auto mt-lg-0">
                    <?php if ($user->isAdmin()): ?>
                        <li class="nav-item">
                            <?= $this->Html->link(__('Nova visita'), ['action' => 'add'], ['class' => 'btn btn-primary me-1']) ?>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
                ...
                <?php foreach ($visitas as $visita): ?>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <?php if ($user->isAdmin()): ?>
                                <?= $this->Html->link(__('Editar'), ['action' => 'edit', $visita->id], ['class' => 'btn btn-primary me-1'])
                                ?>
                                <?= $this->Form->postLink(__('Excluir'), ['action' => 'delete', $visita->id], ['confirm' => __('Tem certeza que quer excluir este registro # {0}?', $visita->id), 'class' => 'btn btn-danger me-1'])
                                ?>
                            <?php endif; ?>
                        </td>
                    </tr>
