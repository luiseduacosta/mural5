...
<div class='container'>
    ...
    <table id="sortableTable" class='table table-hover table-striped table-responsive'>
        ...
        <thead class='thead-light'>
            <tr>
                <th onclick="sortTable(0, 'text')">Aluno <span class="sort-icon"></span></th>
                ...
                <th onclick="sortTable(5, 'text')">Supervisor <span class="sort-icon"></span></th>
                <th onclick="sortTable(6, 'text')">CRESS <span class="sort-icon"></span></th>
                <th onclick="sortTable(7, 'text')">Professor <span class="sort-icon"></span></th>
            </tr>
        </thead>
        <tbody>
