        ...
        <div class="collapse navbar-collapse" id="navbarTogglerUsuario">
            <ul class="navbar-nav ms-auto mt-lg-0">
                <?php if ($user->isAdmin()): ?>
                    ...
                    <li class="nav-item">
                        <?= $this->Form->postLink(__('Excluir'), ['action' => 'delete', $userestagio->id], ['confirm' => __('Tem certeza que quer excluir este registro # {0}?', $userestagio->id), 'class' => 'btn btn-danger me-1']) ?>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
