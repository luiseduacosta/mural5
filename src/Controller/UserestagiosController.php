...
>>>>>>> 8706d66 (Instalei o domPdf e fiz outras correçoes. Está funcionando parecido ao Mural atual.)
...
<<<<<<< HEAD
                    ...
                    if (!$docente) {
                        ...
                        return $this->redirect(['controller' => 'docentes', 'action' => 'add', '?' => ['siape' => $this->Authentication->getIdentityData('numero')]]);
=======
                        ->contain(['Estagiarios'])
                        ->where(['siape' => $this->Authentication->getIdentityData('numero')])
                        ->first();
...
<<<<<<< HEAD
                        ...
                        $this->getRequest()->getSession()->write('categoria', $this->Authentication->getIdentityData('categoria'));
=======
                        return $this->redirect('/supervisores/add?cress=' . $this->Authentication->getIdentityData('numero'));
                    else:
                        $this->getRequest()->getSession()->write('id_categoria', $this->Authentication->getIdentityData('categoria'));
>>>>>>> 8706d66 (Instalei o domPdf e fiz outras correçoes. Está funcionando parecido ao Mural atual.)
